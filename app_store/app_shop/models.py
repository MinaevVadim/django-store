...
class Product(SoftIsDelete):
    ...
    name = models.CharField(
        max_length=1000, db_index=True, verbose_name="название товара"
    )
    ...
    count_reviews = models.IntegerField(default=0, verbose_name="количество отзывов")
    ...
    limited_edition = models.BooleanField(verbose_name="ограниченный тираж")
    ...
    active_product = models.BooleanField(verbose_name="активность товара")
...
class Tag(models.Model):
    ...
    name = models.CharField(max_length=1000, verbose_name="название тега")
...
class Category(MPTTModel, SoftIsDelete):
    ...
    name = models.CharField(
        max_length=1000, db_index=True, verbose_name="название категории"
    )
    ...
    file_icon = models.FileField(
        upload_to="files_icon/", null=True, blank=True, verbose_name="файл иконки"
    )
    objects = SoftDeleteManager()
...
class Comment(models.Model):
    ...
    name_user = models.CharField(
        max_length=100, verbose_name="имя пользователя", blank=True
    )
    text_comment = models.TextField(max_length=10000, verbose_name="текст комментария")
...
class FileProduct(models.Model):
    ...
    files = models.FileField(upload_to="files_goods/", verbose_name="файл")
